...
[filename, pathname] = uigetfile('Modls, ERFA & param/*.mat',...
...
if ~exist('R','var')||~exist('perfa','var')
errordlg('The ERFA file must contain transducer variables such as ''perfa'' and ''R''.','ERROR','modal');
close(hww); 
return; end
